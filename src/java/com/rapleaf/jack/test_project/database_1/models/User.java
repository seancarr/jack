...
public class User extends ModelWithId<User, User.Attributes, IDatabases> {
  ...
  public static class Attributes extends AttributesWithId {
    ...
    public Attributes(long id, final String handle, final Long created_at_millis, final int num_posts, final Long some_date, final Long some_datetime, final String bio, final byte[] some_binary, final Double some_float, final Boolean some_boolean) {
      super(id);
